...
function createPetal6(id: number): Infinite1DMazeSegment {
  const petal = new Infinite1DMazeSegment(new Vector3(), new Euler(), id)
  petal.paused = true
  petal.curIndex = 0 // we will reset the maze and replace it with a pre-chosen seed
  const straight1 = new MazeStraightSegment(new Vector3(101, 57, 0), new Euler(0, 0, Math.PI/2), petal.curIndex++)
  const straight2 = new MazeStraightSegment(new Vector3(105, 57, 0), new Euler(0, 0, Math.PI/2), petal.curIndex++)
  const straight3 = new MazeStraightSegment(new Vector3(109, 57, 0), new Euler(0, 0, Math.PI/2), petal.curIndex++)
  const corner1 = new MazeCornerSegment(new Vector3(113, 57, 0), new Euler(0, 0, Math.PI/2), petal.curIndex++)
  const corner2 = new MazeCornerSegment(new Vector3(113, 61, 0), new Euler(0, 0, -Math.PI/2), petal.curIndex++)
  const deadend = new MazeDeadEndSegment(new Vector3(117, 61, 0), new Euler(0, 0, -Math.PI/2), petal.curIndex++)
...
function createPetal7(id: number): Infinite1DMazeSegment {
  const petal = new Infinite1DMazeSegment(new Vector3(), new Euler(), id)
  petal.paused = true
  petal.curIndex = 0 // we will reset the maze and replace it with a pre-chosen seed
  const straight = new MazeStraightSegment(new Vector3(101, 61, 0), new Euler(0, 0, Math.PI/2), petal.curIndex++)
  const corner1 = new MazeCornerSegment(new Vector3(105, 61, 0), new Euler(0, 0, Math.PI/2), petal.curIndex++)
  const corner2 = new MazeCornerSegment(new Vector3(105, 65, 0), new Euler(0, 0, Math.PI), petal.curIndex++)
  const deadend = new MazeDeadEndSegment(new Vector3(101, 65, 0), new Euler(0, 0, Math.PI/2), petal.curIndex++)
...
function createPetal8(id: number): Infinite1DMazeSegment {
  const petal = new Infinite1DMazeSegment(new Vector3(), new Euler(), id)
  petal.paused = true
  petal.curIndex = 0
  const straight = new MazeStraightSegment(new Vector3(96, 66, 0), new Euler(0, 0, 0), petal.curIndex++)
  const corner = new MazeCornerSegment(new Vector3(96, 70, 0), new Euler(0, 0, -Math.PI/2), petal.curIndex++)
  const deadend = new MazeDeadEndSegment(new Vector3(100, 70, 0), new Euler(0, 0, -Math.PI/2), petal.curIndex++)

  straight.connections[0].connectedTo = corner
  corner.connections[1].connectedTo = straight
...
function createPetal10(id: number): Infinite1DMazeSegment {
  const petal = new Infinite1DMazeSegment(new Vector3(), new Euler(), id)
  petal.paused = true
  petal.curIndex = 0 // we will reset the maze and replace it with a pre-chosen seed
  const straight = new MazeStraightSegment(new Vector3(88, 66, 0), new Euler(0, 0, 0), petal.curIndex++)
  const corner = new MazeCornerSegment(new Vector3(88, 70, 0), new Euler(0, 0, Math.PI), petal.curIndex++)
  const deadend = new MazeDeadEndSegment(new Vector3(84, 70, 0), new Euler(0, 0, Math.PI/2), petal.curIndex++)
...
function createPetal11(id: number): Infinite1DMazeSegment {
  const petal = new Infinite1DMazeSegment(new Vector3(), new Euler(), id)
  petal.paused = true
  petal.curIndex = 0 // we will reset the maze and replace it with a pre-chosen seed
  const straight = new MazeStraightSegment(new Vector3(83, 61, 0), new Euler(0, 0, Math.PI/2), petal.curIndex++)
  const corner1 = new MazeCornerSegment(new Vector3(79, 61, 0), new Euler(0, 0, 0), petal.curIndex++)
  const corner2 = new MazeCornerSegment(new Vector3(79, 65, 0), new Euler(0, 0, -Math.PI/2), petal.curIndex++)
  const deadend = new MazeDeadEndSegment(new Vector3(83, 65, 0), new Euler(0, 0, -Math.PI/2), petal.curIndex++)
