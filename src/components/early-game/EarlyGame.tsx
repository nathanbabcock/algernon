...
import { applause, munch, partyHorn } from '../../helpers/sound'
...
export default function EarlyGame(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <group ref={group} dispose={null}>
      ...
      { stage1Complete && !stage2Complete && <PositionalAudio url="sounds/elevator-music.wav" distance={0.15} loop position={whiteboardPos} /> }
      ...
      { stage2Complete && <PositionalAudio url="sounds/elevator-music.wav" distance={0.15} loop position={whiteboard2Pos}/> }
...
useLoader.preload(AudioLoader, 'sounds/elevator-music.wav')